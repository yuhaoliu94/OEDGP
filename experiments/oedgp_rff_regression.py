...
if __name__ == '__main__':
    ...
    if FLAGS.VI:
        if os.path.exists("Initialization/" + FLAGS.dataset):
            ...
            os.chdir("VI/")
            cmd = "python experiments/dgp_rff_regression.py  --seed=" + str(FLAGS.seed) + " --dataset=" + FLAGS.dataset + \
    ...
    ## Main dgp object
    oedgp = OedgpRff(data, like, data.num_examples, data.X.shape[1], data.Y.shape[1], FLAGS.nl, FLAGS.n_rff,
                     FLAGS.df,
